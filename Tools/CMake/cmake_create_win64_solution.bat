...
:VisitCompilers
set i=0
call :CheckCompiler %1 "HKEY_CLASSES_ROOT\WDExpress.DTE.14.0" "Visual Studio 14 2015 Win64" "Visual Studio 14 2015 Express"
call :CheckCompiler %1 "HKEY_CLASSES_ROOT\VisualStudio.DTE.14.0" "Visual Studio 14 2015 Win64" "Visual Studio 2015"
call :CheckCompiler %1 "HKEY_CLASSES_ROOT\VisualStudio.DTE.15.0" "Visual Studio 15 2017 Win64" "Visual Studio 2017"
goto :eof
