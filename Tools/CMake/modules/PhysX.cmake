...
function(PhysXaddLib version extension)
	...
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Bin/${version}/PhysX3${extension}_x64.dll")
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Bin/${version}/PhysX3CharacterKinematic${extension}_x64.dll")
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Bin/${version}/PhysX3Common${extension}_x64.dll")
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Bin/${version}/PhysX3Cooking${extension}_x64.dll")

	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Lib/${version}/PhysX3${extension}_x64.lib")
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Lib/${version}/PhysX3Common${extension}_x64.lib")
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Lib/${version}/PhysX3Extensions${extension}.lib")
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Lib/${version}/PhysXProfileSDK${extension}.lib")
	set_target_properties(PHYSX PROPERTIES IMPORTED_LOCATION "${SDK_DIR}/PhysX/Lib/${version}/PhysXVisualDebuggerSDK${extension}.lib")
...
set_target_properties(PHYSX PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SDK_DIR}/PhysX/Include")
