...
elseif(DURANGO)
	add_library(fmod SHARED IMPORTED GLOBAL)
	set(FMOD_DLL "${FMOD_DIR}/xboxone/api/lowlevel/lib/fmod.dll")
	set_target_properties(fmod PROPERTIES IMPORTED_LOCATION "${FMOD_DLL}")
	set_target_properties(fmod PROPERTIES IMPORTED_IMPLIB "${FMOD_DIR}/xboxone/api/lowlevel/lib/fmod_vc.lib")
	set_target_properties(fmod PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${FMOD_DIR}/xboxone/api/lowlevel/inc")
