...
MESSAGE( "BUILD_CPU_ARCHITECTURE = ${BUILD_CPU_ARCHITECTURE}" )

if (${CMAKE_GENERATOR} MATCHES "Visual Studio 14 2015 Win64" OR ${CMAKE_GENERATOR} MATCHES "Visual Studio 13 2015 Win64")
	#message( "Visual Studio 2013/2015 uses v110 toolset (Visual Studio 2012 compiler)" )
	#set(CMAKE_GENERATOR_TOOLSET v110)
endif()
