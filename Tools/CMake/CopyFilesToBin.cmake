...
macro(deploy_pyside)
	set(PYSIDE_SDK_SOURCE "${SDK_DIR}/Qt/5.12.3/msvc2017_64/PySide/")
...
macro(copy_binary_files_to_target)
	...
	if (WINDOWS)
		...
		if (OPTION_SANDBOX)
			...
			deploy_runtime_files("${SDK_DIR}/Qt/5.12.3/msvc2017_64/Qt/bin/*.dll" "")
			deploy_runtime_files("${SDK_DIR}/Qt/5.12.3/msvc2017_64/Qt/bin/QtWebEngineProcess.exe" "")
			deploy_runtime_files("${SDK_DIR}/Qt/5.12.3/msvc2017_64/PySide/PySide2/qt.conf" "")
			deploy_runtime_files("${SDK_DIR}/Qt/5.12.3/msvc2017_64/PySide/PySide2/shiboken2.pyd" "")
			file(COPY ${SDK_DIR}/Qt/5.12.3/msvc2017_64/Qt/plugins DESTINATION ${base_outdir})
			file(COPY ${SDK_DIR}/Qt/5.12.3/msvc2017_64/Qt/resources DESTINATION ${base_outdir})
			file(COPY ${SDK_DIR}/Qt/5.12.3/msvc2017_64/Qt/translations/qtwebengine_locales/en-US.pak DESTINATION "${base_outdir}/translations/qtwebengine_locales")
