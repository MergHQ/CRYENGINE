...
public:
	...
	static void OnAudioTriggerStarted(const Cry::Audio::SRequestInfo* const pAudioRequestInfo);
	static void OnAudioTriggerFinished(const Cry::Audio::SRequestInfo* const pAudioRequestInfo);

protected:
	void ShowSubtitle(const Cry::Audio::SRequestInfo* const pAudioRequestInfo, bool bShow);
