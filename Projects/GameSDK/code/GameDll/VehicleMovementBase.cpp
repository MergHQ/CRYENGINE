...
{ 
	...
	{
		m_audioControlIDs[i] = Cry::Audio::InvalidControlId;
	}
...
bool CVehicleMovementBase::Init(IVehicle* pVehicle, const CVehicleParams& table)
{
	...
	Cry::Audio::ControlId const surfaceStateId = Cry::Audio::StringToId("concrete");
...
void CVehicleMovementBase::StopEngine()
{
	...
	if (GetAudioControlID(eSID_Stop) != Cry::Audio::InvalidControlId)
	{
	...
	case eVE_PassengerExit:
		{
			...
			Cry::Audio::ControlId const outStateId = Cry::Audio::StringToId("outside");
			Cry::Audio::ControlId const inStateId = Cry::Audio::StringToId("inside");
...
{
	IEntityAudioComponent* pIEntityAudioComponent = GetAudioProxy();
	CRY_ASSERT(pIEntityAudioComponent && eSID>=0 && eSID<eSID_Max);

	const Cry::Audio::ControlId id = m_audioControlIDs[eSID];
	if (id != Cry::Audio::InvalidControlId)
	{
...
void CVehicleMovementBase::UpdateSurfaceEffects(const float deltaTime)
{
  ...
  { 
    if (!CRY_VERIFY(emitterIt->layer >= 0))
    {
      continue;
    }
...
//------------------------------------------------------------------------
const Cry::Audio::ControlId& CVehicleMovementBase::GetAudioControlID(EVehicleMovementSound eSID)
{
  CRY_ASSERT(eSID>=0 && eSID<eSID_Max);
...
void CVehicleMovementBase::CacheAudioControlIDs()
{
	...
	m_audioControlIDs[eSID_Start] = Cry::Audio::StringToId(triggerName.Format("Play_%s_start", szVehicleName).c_str());
	m_audioControlIDs[eSID_Run] = Cry::Audio::StringToId(triggerName.Format("Play_%s_run", szVehicleName).c_str());
	m_audioControlIDs[eSID_Stop] = Cry::Audio::StringToId(triggerName.Format("Play_%s_stop", szVehicleName).c_str());
	m_audioControlIDs[eSID_Ambience] = Cry::Audio::StringToId(triggerName.Format("Play_%s_ambience", szVehicleName).c_str());
	m_audioControlIDs[eSID_Bump] = Cry::Audio::StringToId(triggerName.Format("Play_%s_bump", szVehicleName).c_str());
	m_audioControlIDs[eSID_Splash] = Cry::Audio::StringToId(triggerName.Format("Play_%s_splash", szVehicleName).c_str());
	m_audioControlIDs[eSID_Gear] = Cry::Audio::StringToId(triggerName.Format("Play_%s_gear", szVehicleName).c_str());
	m_audioControlIDs[eSID_Slip] = Cry::Audio::StringToId(triggerName.Format("Play_%s_slip", szVehicleName).c_str());
	m_audioControlIDs[eSID_Acceleration] = Cry::Audio::StringToId(triggerName.Format("Play_%s_acceleration", szVehicleName).c_str());
	m_audioControlIDs[eSID_Boost] = Cry::Audio::StringToId(triggerName.Format("Play_%s_boost", szVehicleName).c_str());
	m_audioControlIDs[eSID_Damage] = Cry::Audio::StringToId(triggerName.Format("Play_%s_damage", szVehicleName).c_str());
	m_audioControlIDs[eSID_StopDamage] = Cry::Audio::StringToId(triggerName.Format("Stop_%s_damage", szVehicleName).c_str());

	m_audioControlIDs[eSID_VehicleRPM] = Cry::Audio::StringToId("vehicle_rpm");
	m_audioControlIDs[eSID_VehicleSpeed] = Cry::Audio::StringToId("vehicle_speed");
	m_audioControlIDs[eSID_VehicleDamage] = Cry::Audio::StringToId("vehicle_damage");
	m_audioControlIDs[eSID_VehicleSlip] = Cry::Audio::StringToId("vehicle_slip");
	m_audioControlIDs[eSID_VehicleStroke] = Cry::Audio::StringToId("vehicle_stroke");

	m_audioControlIDs[eSID_VehicleSurface] = Cry::Audio::StringToId("SurfaceType");
	m_audioControlIDs[eSID_VehicleINOUT] = Cry::Audio::StringToId("in_out");
}
