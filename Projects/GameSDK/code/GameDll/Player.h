...
public:
	...
	virtual EntityId GetSpectatorTarget() const override { CRY_ASSERT(m_stats.spectatorInfo.mode==eASM_Follow||m_stats.spectatorInfo.mode==eASM_Killer); return m_stats.spectatorInfo.mode==eASM_Follow?m_stats.spectatorInfo.dataU.follow.spectatorTarget:m_stats.spectatorInfo.dataU.killer.spectatorTarget; }
	...
	virtual EntityId GetSpectatorFixedLocation() const override { CRY_ASSERT(m_stats.spectatorInfo.mode==eASM_Fixed); return m_stats.spectatorInfo.dataU.fixed.location; }
...
protected:
	...
	Cry::Audio::ControlId m_waterEnter;
	Cry::Audio::ControlId m_waterExit;
	Cry::Audio::ControlId m_waterDiveIn;
	Cry::Audio::ControlId m_waterDiveOut;
	Cry::Audio::ControlId m_waterInOutSpeed;
...
private:
	...
	typedef std::map<int32, Cry::Audio::AuxObjectId> TJointToAudioProxyLookup;
