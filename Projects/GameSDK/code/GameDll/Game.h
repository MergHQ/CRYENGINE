...
#include <CryAISystem/IAISystemLegacy.h>
...
public:
	...
	GlobalRayCaster&          GetRayCaster()              { CRY_ASSERT(m_pRayCaster); return *m_pRayCaster; }
	GlobalIntersectionTester& GetIntersectionTester()     { CRY_ASSERT(m_pIntersectionTester); return *m_pIntersectionTester; }
