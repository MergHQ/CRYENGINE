...
static inline void InlineInitializationProcessing_1(const char *sDescription)
{
...
IGameRef CGameStartup::Init(SSystemInitParams &startupParams)
{
	...
	InlineInitializationProcessing_1("CGameStartup::Init");
	...
	InlineInitializationProcessing_1("CGameStartup::Init End");
