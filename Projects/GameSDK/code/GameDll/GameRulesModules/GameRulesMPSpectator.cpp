...
#define ASSERT_IS_CLIENT if (!CRY_VERIFY(gEnv->IsClient())) { return; }
#define ASSERT_IS_SERVER if (!CRY_VERIFY(gEnv->bServer)) { return; }
#define ASSERT_IS_SERVER_RETURN_FALSE if (!CRY_VERIFY(gEnv->bServer)) { return false; }
