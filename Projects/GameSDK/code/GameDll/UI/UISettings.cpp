...
////////////////////////////////////////////////////////////////////////////
static void SetVolume(Cry::Audio::ControlId id, float volume)
{
...
void CUISettings::InitEventSystem()
{
	...
	m_musicVolumeId = Cry::Audio::StringToId("volume_music");
	m_sfxVolumeId = Cry::Audio::StringToId("volume_sfx");
