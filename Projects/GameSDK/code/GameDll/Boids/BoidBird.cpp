...
namespace BoidBirdConstants
{
	constexpr int MAX_BIRDS_DISTANCE = 300;

	constexpr int MAX_FLIGHT_TIME = 10;
	constexpr int MIN_FLIGHT_TIME = 10;
	constexpr int BIRDS_PHYSICS_DENSITY = 200;
	constexpr int BIRDS_PHYSICS_INWATER_DENSITY = 900;
	constexpr int TAKEOFF_TIME = 3;

	constexpr int SCARE_DISTANCE = 10;
}
...
{
	using namespace BoidBirdConstants;
	if (m_pPhysics)
	{
		pe_status_pos ppos;
