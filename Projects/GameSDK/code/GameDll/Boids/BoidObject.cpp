...
namespace BoidConstants
{
	constexpr int BIRDS_PHYSICS_DENSITY = 200;
	constexpr int BIRDS_PHYSICS_INWATER_DENSITY = 900;
	constexpr int FISH_PHYSICS_DENSITY = 850;
	...
	constexpr float SCARE_DISTANCE = 10;
...
void CBoidObject::ExecuteTrigger(int nIndex)
{
	...
	{
		const Cry::Audio::ControlId id = m_flock->m_bc.audio[nIndex];
