...
public:
	...
	static void                 OnAudioTriggerFinished(Cry::Audio::SRequestInfo const* const pAudioRequestInfo);
	static const char*          GetClassIdentifier() { return "DialogActorContext"; }

	static CDialogActorContext* GetDialogActorContextByAudioCallbackData(Cry::Audio::SRequestInfo const* const pAudioRequestInfo);
...
protected:
	...
	Cry::Audio::AuxObjectId             m_SpeechAuxObject;
