...
bool CDialogScript::AddLine(TActorID actorID, Cry::Audio::ControlId audioID, const char* anim, const char* facial, TActorID lookAtTargetID, float delay, float facialWeight, float facialFadeTime, bool bLookAtSticky, bool bResetFacial, bool bResetLookAt, bool bSoundStopsAnim, bool bUseAGSignal, bool bUseAGEP)
{
	SScriptLine line;
...
{
	if (m_bComplete && CRY_VERIFY(index >= 0 && index < m_lines.size()))
