...
{
	CRY_ASSERT(adbFileName != NULL);
	CRY_ASSERT(strlen(adbFileName) < m_ADBFileName.MAX_SIZE);
...
{
	CRY_ASSERT(currentFightProgress != NULL);
	CRY_ASSERT(currentFightProgressInv != NULL);
