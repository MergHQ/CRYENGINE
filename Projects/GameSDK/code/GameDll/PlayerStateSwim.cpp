...
Cry::Audio::ControlId CPlayerStateSwim::m_submersionDepthParam = Cry::Audio::InvalidControlId;
...
{
	m_submersionDepthParam = Cry::Audio::StringToId("submersion_depth");
}
...
{
	if (m_submersionDepthParam != Cry::Audio::InvalidControlId)
	{
