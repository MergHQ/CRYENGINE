...
public:  
	...
	virtual Cry::Audio::ControlId GetPrimaryWeaponAudioTrigger() const override { return m_audioControlIDs[eSID_VehiclePrimaryWeapon]; }
	virtual Cry::Audio::ControlId GetPrimaryWeaponAudioStopTrigger() const override { return m_audioControlIDs[eSID_VehicleStopPrimaryWeapon]; }
	virtual Cry::Audio::ControlId GetSecondaryWeaponAudioTrigger() const override { return m_audioControlIDs[eSID_VehicleSecondaryWeapon]; }
	virtual Cry::Audio::ControlId GetSecondaryWeaponAudioStopTrigger() const override { return m_audioControlIDs[eSID_VehicleStopSecondaryWeapon]; }
...
protected:
	...
	const Cry::Audio::ControlId& GetAudioControlID(EVehicleMovementSound eSID);
...
protected:
	...
	Cry::Audio::ControlId m_audioControlIDs[eSID_Max];
