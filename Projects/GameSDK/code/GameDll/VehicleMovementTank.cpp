...
bool CVehicleMovementTank::Init(IVehicle* pVehicle, const CVehicleParams& table)
{
	...
	{
		m_audioControlIDs[eSID_TankTurnTurret] = Cry::Audio::StringToId("Play_abrams_cannon_turn");
		m_turretTurnRtpcId = Cry::Audio::StringToId("vehicle_rotation_speed");

		m_audioControlIDs[eSID_VehiclePrimaryWeapon] = Cry::Audio::StringToId("Play_w_tank_cannon_fire");
		m_audioControlIDs[eSID_VehicleStopPrimaryWeapon] = Cry::Audio::InvalidControlId;
		m_audioControlIDs[eSID_VehicleSecondaryWeapon] = Cry::Audio::StringToId("Play_w_tank_machinegun_fire");
		m_audioControlIDs[eSID_VehicleStopSecondaryWeapon] = Cry::Audio::StringToId("Stop_w_tank_machinegun_fire");
...
void CVehicleMovementTank::Update(const float deltaTime)
{
	...
	Cry::Audio::ControlId id = m_audioControlIDs[eSID_TankTurnTurret];
