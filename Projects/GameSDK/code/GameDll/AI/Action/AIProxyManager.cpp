...
void CAIProxyManager::Init()
{
	...
	gEnv->pAISystem->Legacy()->SetActorProxyFactory(this);
	gEnv->pAISystem->Legacy()->SetGroupProxyFactory(this);
}
...
void CAIProxyManager::Shutdown()
{
	...
	gEnv->pAISystem->Legacy()->SetActorProxyFactory(NULL);
	gEnv->pAISystem->Legacy()->SetGroupProxyFactory(NULL);
}
