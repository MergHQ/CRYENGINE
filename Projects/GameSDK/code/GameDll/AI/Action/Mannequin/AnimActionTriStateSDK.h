...
class CAnimActionTriStateGameSDK;

struct IAnimActionTriStateListenerGameSDK
{
	virtual ~IAnimActionTriStateListenerGameSDK() {}

	// Called when the action is entered (called before Intro)
	virtual void OnAnimActionTriStateEnter(class CAnimActionTriStateGameSDK* pAction) {}

	// Called when the Intro substate starts (also when there is no animation for it)
	virtual void OnAnimActionTriStateIntro(class CAnimActionTriStateGameSDK* pAction) {}
	...
	virtual void OnAnimActionTriStateMiddle(class CAnimActionTriStateGameSDK* pAction) {}
	...
	virtual void OnAnimActionTriStateOutro(class CAnimActionTriStateGameSDK* pAction) {}
	...
	virtual void OnAnimActionTriStateOutroEnd(class CAnimActionTriStateGameSDK* pAction) {}

	// Called when the action is exited (guaranteed to be called when Enter was
	// called before -- except in error cases)
	virtual void OnAnimActionTriStateExit(class CAnimActionTriStateGameSDK* pAction) {}
};

//---------------------------------------------------------------------------------------------------

class CAnimActionTriStateGameSDK : public TAction<SAnimationContext>
{
public:
	...
	CAnimActionTriStateGameSDK(int priority, FragmentID fragmentID, IAnimatedCharacter& animChar, bool oneShot, float maxMiddleDuration = -1, bool skipIntro = false, IAnimActionTriStateListenerGameSDK* pListener = NULL);
...
protected:
	...
	IAnimActionTriStateListenerGameSDK* m_pListener;
