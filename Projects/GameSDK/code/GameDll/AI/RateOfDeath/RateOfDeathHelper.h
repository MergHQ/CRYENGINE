...
public:
	...
	void SetTarget( const AILegacy::IAIObject* pTarget );

	const AILegacy::IAIObject* GetAIObject() const;
	const AILegacy::IAIActor* GetAIActor() const;
...
private:
	const AILegacy::IAIObject* m_pTarget;
	const AILegacy::IAIActor* m_pTargetActor;
