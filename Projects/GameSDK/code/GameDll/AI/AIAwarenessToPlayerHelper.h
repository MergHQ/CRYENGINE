...
class CAIAwarenessToPlayerHelper
{
	public:
		...
		struct IAwarenessEntity
		{
			...
			virtual int GetAwarenessToActor(AILegacy::IAIObject* pAIObject, CActor* pActor ) const = 0;
		};
	...
	private:
		...
		int GetAlertnessAffectedByVisibility(const AILegacy::IAIActor& aiActor, const AILegacy::IAIObject& playerAiObject, const bool playerIsCloaked) const;
