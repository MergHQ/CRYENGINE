...
void CSubtitleManager::SetEnabled(bool bEnabled)
{
	if (bEnabled != m_bEnabled)
	{
		...
		if (m_bAutoMode)
		{
			if (bEnabled)
			{
				gEnv->pAudioSystem->AddRequestListener(&CSubtitleManager::OnAudioTriggerStarted, nullptr, Cry::Audio::ESystemEvents::TriggerExecuted);
				gEnv->pAudioSystem->AddRequestListener(&CSubtitleManager::OnAudioTriggerFinished, nullptr, Cry::Audio::ESystemEvents::TriggerFinished);
			}
			else
			{
...
//////////////////////////////////////////////////////////////////////////
void CSubtitleManager::ShowSubtitle(const Cry::Audio::SRequestInfo* const pAudioRequestInfo, bool bShow)
{
	if (m_bEnabled && m_pHandler)
	{
...
//////////////////////////////////////////////////////////////////////////
void CSubtitleManager::OnAudioTriggerStarted(const Cry::Audio::SRequestInfo* const pAudioRequestInfo)
{
	CSubtitleManager::s_Instance->ShowSubtitle(pAudioRequestInfo, true);
}

//////////////////////////////////////////////////////////////////////////
void CSubtitleManager::OnAudioTriggerFinished(const Cry::Audio::SRequestInfo* const pAudioRequestInfo)
{
