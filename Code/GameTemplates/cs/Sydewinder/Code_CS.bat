...
if defined engine_root (
	...
	xcopy /R/Y "%engine_root%\%bin_folder%\CryEngine.Common.dll" "%bin_folder%\" >NUL
	xcopy /R/Y "%engine_root%\%bin_folder%\CryEngine.Common.dll" "%bin_folder%\mono\AddIns\" >NUL
