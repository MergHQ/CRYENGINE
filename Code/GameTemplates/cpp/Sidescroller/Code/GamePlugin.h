...
public:
	...
	CRYGENERATE_SINGLETONCLASS(CGamePlugin, "Game_Sidescroller", 0xF01244B0A4E74DC6, 0x91E10ED18906FE7C)

	//! Retrieve name of plugin.
	virtual const char* GetName() const override { return "SidescrollerGamePlugin"; }
