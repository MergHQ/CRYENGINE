	...
	: public IEntityRegistrator
{
	...
	void RegisterCVars()
	{
		m_pGeometry = REGISTER_STRING("w_bulletGeometry", "Objects/Default/primitive_sphere.cgf", VF_CHEAT, "Sets the path to the geometry assigned to every weapon bullet");
