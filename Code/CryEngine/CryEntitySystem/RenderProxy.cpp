...
{
	EntityEventMask events = BIT64(ENTITY_EVENT_XFORM) | BIT64(ENTITY_EVENT_ATTACH_THIS) | BIT64(ENTITY_EVENT_DETACH_THIS) | BIT64(ENTITY_EVENT_LINK)
	                         | BIT64(ENTITY_EVENT_DELINK) | BIT64(ENTITY_EVENT_ENABLE_PHYSICS) | BIT64(ENTITY_EVENT_PHYSICS_CHANGE_STATE) | BIT64(ENTITY_EVENT_HIDE)
	                         | BIT64(ENTITY_EVENT_INVISIBLE) | BIT64(ENTITY_EVENT_UNHIDE) | BIT64(ENTITY_EVENT_VISIBLE) | BIT64(ENTITY_EVENT_ANIM_EVENT);
