...
bool CEntityPool::ConsumePool(CEntityPool& otherPool)
{
	...
	if (otherPool.m_Id != INVALID_ENTITY_POOL)
	{
		...
		auto lastInactivePoolId = std::unique(m_InactivePoolIds.begin(), m_InactivePoolIds.end());
		m_InactivePoolIds.erase(lastInactivePoolId, m_InactivePoolIds.end());
		...
		auto lastActivePoolId = std::unique(m_ActivePoolIds.begin(), m_ActivePoolIds.end());
		m_ActivePoolIds.erase(lastActivePoolId, m_ActivePoolIds.end());
		...
		auto lastPoolDefinitions = std::unique(m_PoolDefinitionIds.begin(), m_PoolDefinitionIds.end());
		m_PoolDefinitionIds.erase(lastPoolDefinitions, m_PoolDefinitionIds.end());
