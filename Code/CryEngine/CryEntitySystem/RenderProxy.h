...
private:
	...
	uint32 m_bInitialized   : 1; // Entity was initialized
	uint32 m_bBoundsFixed   : 1; // Bounding box should not be recalculated
	uint32 m_bBoundsValid   : 1; // Bounding box is invalid and be recalculated
	uint32 m_bHaveParticles : 1; // Particle system added
