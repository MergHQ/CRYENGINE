...
public:
    ...
    virtual bool SerializeKeys(XmlNodeRef& xmlNode, bool bLoading, std::vector<size_t>& serializedKeysIndices, const SAnimTime time = SAnimTime(0)) override { return false; };
