...
public:
	...
	struct SScriptLine
	{
		...
		SScriptLine(TActorID actor, TActorID lookat, AudioControlId audioID, const char* anim, const char* facial, float delay, float facialWeight, float facialFadeTime, bool bLookAtSticky, bool bResetFacial, bool bResetLookAt, bool bSoundStopsAnim, bool bUseAGSignal, bool bUseAGEP)
			: m_actor(actor),
...
public:
	...
	bool AddLine(TActorID actorID, AudioControlId audioID, const char* anim, const char* facial, TActorID lookAtTargetID, float delay, float facialWeight, float facialFadeTime, bool bLookAtSticky, bool bResetFacial, bool bResetLookAt, bool bSoundStopsAnim, bool bUseAGSignal, bool bUseAGEP);
