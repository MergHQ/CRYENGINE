...
{
	desc.SetGUID("a9279137-7c66-491d-b9a0-8752c24c8979"_schematyc_guid);
	desc.SetLabel("Start");
...
{
	desc.SetGUID("52ad5add-7781-429b-b4a9-0cb6c905e353"_schematyc_guid);
	desc.SetLabel("Stop");
...
{
	desc.SetGUID("b2561caa-0753-458b-a91f-e8e38b0f0cdf"_schematyc_guid);
