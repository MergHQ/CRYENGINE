...
public:
	...
	inline CEnvInterface(const SGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
...
public:
	...
	inline CEnvInterfaceFunction(const SGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
		: CEnvElementBase(guid, szName, sourceFileInfo)
	{}
...
{
inline std::shared_ptr<CEnvInterface> MakeShared(const SGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
{
...
{
inline std::shared_ptr<CEnvInterfaceFunction> MakeShared(const SGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
{
