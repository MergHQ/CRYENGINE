...
public:
	...
	template<typename FUNCTION_PTR_TYPE> inline CEnvFunction(FUNCTION_PTR_TYPE pFunction, const SGUID& guid, const char* szName, const SSourceFileInfo& sourceFileInfo)
