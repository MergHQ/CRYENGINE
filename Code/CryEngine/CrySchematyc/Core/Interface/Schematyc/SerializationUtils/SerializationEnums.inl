...
SERIALIZATION_ENUM(Schematyc::EScriptElementType::Import, "Import", "Import")
SERIALIZATION_ENUM(Schematyc::EScriptElementType::Filter, "Filter", "Filter")
...
SERIALIZATION_ENUM(Schematyc::EScriptElementType::Destructor, "Destructor", "Destructor")
