...
public:
	...
	virtual void OnPreRun(CParticleComponentRuntime& runtime, uint numParticles) {}
...
struct SFeatureDispatchers
{
	...
	TFeatureDispatcher<CParticleComponentRuntime&, uint> OnPreRun { &CParticleFeature::OnPreRun };
