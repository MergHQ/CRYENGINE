...
private:
	...
	CryMT::CThreadSafePushContainer<SLightVolInfo> m_pLightVolsInfo;                      // World cells data
	int        m_lightVolsInfoCount;                             // number of elements in m_pLightVolsInfo (it only exposes capacity)
