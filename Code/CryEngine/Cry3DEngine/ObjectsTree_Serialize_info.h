...
STRUCT_INFO_BEGIN(SLightPropagationVolumeChunk)
STRUCT_BASE_INFO(SRenderNodeChunk)
STRUCT_VAR_INFO(m_WorldMatrix, TYPE_INFO(Matrix34))
STRUCT_VAR_INFO(m_fDensity, TYPE_INFO(float))
STRUCT_VAR_INFO(m_bIsSpecular, TYPE_INFO(uint32))
STRUCT_INFO_END(SLightPropagationVolumeChunk)
