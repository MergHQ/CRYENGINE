...
STRUCT_VAR_INFO(_obsolete_SecsPerTick, TYPE_INFO(float))
STRUCT_VAR_INFO(_obsolete_TicksPerFrame, TYPE_INFO(int))
STRUCT_VAR_INFO(global_range, TYPE_INFO(RANGE_ENTITY))
STRUCT_VAR_INFO(_obsolete_SubRanges, TYPE_INFO(int))
