...
namespace Schematyc2
{
	...
	struct IDocGraphNodeCompiler
	{
		...
		virtual void Push(const IAny& value, const SGUID& originGuid, const char* originInput) = 0;
		virtual void Set(size_t pos, const IAny& value, const SGUID& originGuid, const char* originInput) = 0;
		virtual void Copy(size_t srcPos, size_t dstPos, const IAny& value, const SGUID& originGuid, const char* originInput) = 0;
		virtual void Pop(size_t count) = 0;
		virtual size_t Load(const SGUID& guid) = 0;
		virtual size_t Store(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void ContainerAdd(const SGUID& guid, const IAny& value) = 0;
		virtual void ContainerRemoveByIndex(const SGUID& guid, const IAny& value) = 0;
		...
		virtual void StartTimer(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void StopTimer(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void ResetTimer(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void SendSignal(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void BroadcastSignal(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void CallGlobalFunction(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void CallEnvAbstractInterfaceFunction(const SGUID& abstractInterfaceGUID, const SGUID& functionGUID, const SGUID& originGuid) = 0;
		virtual void CallLibAbstractInterfaceFunction(const SGUID& abstractInterfaceGUID, const SGUID& functionGUID, const SGUID& originGuid) = 0;
		virtual void CallComponentMemberFunction(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void CallActionMemberFunction(const SGUID& guid, const SGUID& originGuid) = 0;
		virtual void CallLibFunction(const LibFunctionId& functionId, const SGUID& originGuid) = 0;
		virtual void Return(const SGUID& originGuid) = 0;
		virtual void SetDebugInput(const SGUID& originGuid, const char* originInput) = 0;
	};
