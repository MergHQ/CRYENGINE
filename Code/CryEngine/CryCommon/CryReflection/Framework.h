...
inline bool ReflectBaseType(Reflection::ITypeDesc& typeDesc, Type::Utils::Explicit<TYPE>, Type::Utils::Explicit<BASE_TYPE>, const SSourceFileInfo& srcInfo)
{
...
#define CRY_REFLECT_BASE(typeDesc, classType, baseType) \
  Cry::Reflection::ReflectBaseType(typeDesc, Cry::Type::Utils::Explicit<typename Cry::Type::PureType<classType>::Type>(), Cry::Type::Utils::Explicit<typename Cry::Type::PureType<baseType>::Type>(),  Cry::Reflection::SSourceFileInfo(__FILE__, __LINE__, __FUNCTION__))
