...
void CUnderwaterGodRays::Render(const std::shared_ptr<CGraphicsPipeline>& pGraphicsPipeline)
{
...
void CWaterDroplets::Render(const std::shared_ptr<CGraphicsPipeline>& pGraphicsPipeline)
{
	ASSERT_LEGACY_PIPELINE
/*
...
void CWaterFlow::Render(const std::shared_ptr<CGraphicsPipeline>& pGraphicsPipeline)
{
	ASSERT_LEGACY_PIPELINE
/*
	gRenDev->m_cEF.mfRefreshSystemShader("PostEffectsGame", CShaderMan::s_shPostEffectsGame);
