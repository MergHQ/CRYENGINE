...
#include <CryRenderer/RenderElements/CREImposter.h>
...
bool CREImposter::IsImposterValid(const CRenderCamera& cam, float fRadiusX, float fRadiusY, float fCamRadiusX, float fCamRadiusY,
                                  const int iRequiredLogResX, const int iRequiredLogResY, const uint32 dwBestEdge)
{
	...
	Vec3 vOldEye = m_vFarPoint - m_LastCamera.vOrigin;
