...
namespace Schematyc2
{
	...
	public:
		...
		virtual void Push(const IAny& value, const SGUID& originGuid, const char* originInput) override;
		virtual void Set(size_t pos, const IAny& value, const SGUID& originGuid, const char* originInput) override;
		virtual void Copy(size_t srcPos, size_t dstPos, const IAny& value, const SGUID& originGuid, const char* originInput) override;
		virtual void Pop(size_t count) override;
		virtual size_t Load(const SGUID& guid) override;
		virtual size_t Store(const SGUID& guid, const SGUID& originGuid) override;
		virtual void ContainerAdd(const SGUID& guid, const IAny& value) override;
		virtual void ContainerRemoveByIndex(const SGUID& guid, const IAny& dummyValue) override;
		...
		virtual void StartTimer(const SGUID& guid, const SGUID& originGuid) override;
		virtual void StopTimer(const SGUID& guid, const SGUID& originGuid) override;
		virtual void ResetTimer(const SGUID& guid, const SGUID& originGuid) override;
		virtual void SendSignal(const SGUID& guid, const SGUID& originGuid) override;
		virtual void BroadcastSignal(const SGUID& guid, const SGUID& originGuid) override;
		virtual void CallGlobalFunction(const SGUID& guid, const SGUID& originGuid) override;
		virtual void CallEnvAbstractInterfaceFunction(const SGUID& abstractInterfaceGUID, const SGUID& functionGUID, const SGUID& originGuid) override;
		virtual void CallLibAbstractInterfaceFunction(const SGUID& abstractInterfaceGUID, const SGUID& functionGUID, const SGUID& originGuid) override;
		virtual void CallComponentMemberFunction(const SGUID& guid, const SGUID& originGuid) override;
		virtual void CallActionMemberFunction(const SGUID& guid, const SGUID& originGuid) override;
		virtual void CallLibFunction(const LibFunctionId& functionId, const SGUID& originGuid) override;
		virtual void Return(const SGUID& originGuid) override;
		virtual void SetDebugInput(const SGUID& originGuid, const char* originInput) override;
		// ~IDocGraphSequenceCompiler
