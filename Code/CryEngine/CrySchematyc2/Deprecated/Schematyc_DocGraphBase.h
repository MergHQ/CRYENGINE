...
namespace Schematyc2
{
	...
	struct SDocGraphNode // N.B. This is a workaround for issues with the serialization system causing serialization function from Schematyc_ScriptGraphBase.cpp to be called.
	{
		SDocGraphNode();
