...
#include "StdAfx.h"
#include "Script/Schematyc_ScriptGraphBase.h"

#include <CrySchematyc2/Serialization/Schematyc_ISerializationContext.h>

#include "Schematyc_DomainContext.h"
#include "Script/GraphNodes/Schematyc_ScriptGraphCommentNode.h"    // #SchematycTODO : Where should script graph node creators be registered?
#include "Script/GraphNodes/Schematyc_ScriptGraphBeginNode.h"    // #SchematycTODO : Where should script graph node creators be registered?
#include "Script/GraphNodes/Schematyc_ScriptGraphFunctionNode.h" // #SchematycTODO : Where should script graph node creators be registered?
#include "Script/GraphNodes/Schematyc_ScriptGraphGetNode.h"      // #SchematycTODO : Where should script graph node creators be registered?
#include "Script/GraphNodes/Schematyc_ScriptGraphNodeFactory.h"  // #SchematycTODO : Where should the script graph node factory live?
#include "Script/GraphNodes/Schematyc_ScriptGraphSwitchNode.h"   // #SchematycTODO : Where should script graph node creators be registered?
