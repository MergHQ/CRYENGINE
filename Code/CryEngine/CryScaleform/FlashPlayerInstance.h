...
public:
	...
	IScaleformPlayback* GetPlayback() { return nullptr; }
...
public:
	...
	SF_MEMORY_REDEFINE_NEW(CFlashPlayer, Stat_Default_Mem)
...
private:
	Scaleform::Render::RenderTarget* CreateRenderTarget(CTexture* pTexture);
...
private:
	...
	static int                     ms_sys_flash_mipmaps;
...
private:
	...
	GPtr<Scaleform::Render::CSFRenderCache> m_pRenderCache;
	#if defined(ENABLE_DYNTEXSRC_PROFILING)
