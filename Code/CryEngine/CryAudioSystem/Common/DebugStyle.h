...
constexpr float s_systemHeaderFontSize = 1.5f;
constexpr float s_systemHeaderLineHeight = 20.0f;
constexpr float s_systemHeaderLineSpacerHeight = 4.0f;
constexpr float s_systemFontSize = 1.35f;
constexpr float s_systemLineHeight = 16.0f;
...
constexpr float s_objectFontSize = 1.35f;
constexpr float s_objectLineHeight = 14.0f;
...
constexpr float s_listHeaderFontSize = 1.5f;
constexpr float s_listHeaderLineHeight = 16.0f;
constexpr float s_listFontSize = 1.25f;
constexpr float s_listLineHeight = 11.0f;
