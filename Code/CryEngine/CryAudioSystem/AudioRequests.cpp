	...
	case ERequestType::ManagerRequest:
		{
			...
			switch (pBase->managerRequestType)
			{
				...
				AM_REQUEST_BLOCK(EManagerRequestType::RegisterListener)
				AM_REQUEST_BLOCK(EManagerRequestType::ReleaseListener)
				AM_REQUEST_BLOCK(EManagerRequestType::RegisterObject)
				AM_REQUEST_BLOCK(EManagerRequestType::ReleaseObject)
