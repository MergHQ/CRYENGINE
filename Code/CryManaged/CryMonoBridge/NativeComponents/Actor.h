...
// Actor implementation holding managed pointers
// We need to have this on the native side since reloading will invalidate pointers
class CManagedActor : public IActor
{
public:
	virtual ~CManagedActor();
	...
	virtual const void*            GetRMIBase(void) const override { return nullptr; }
	// ~IGameObjectExtension
