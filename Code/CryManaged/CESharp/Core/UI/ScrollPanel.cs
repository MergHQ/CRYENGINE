		...
		public bool IsVertical
		{
			set
			{
				...
				if (value) 
				{
					...
					Background.Source = ResourceManager.ImageFromFile (Application.UIPath + "vsplit_bar.png", false);
					Background.SliceType = SliceType.ThreeVertical;
					_scrollArea.Background.Source = ResourceManager.ImageFromFile (Application.UIPath + "vsplit_bar_knob.png", false);
				...
				else 
				{
					...
					Background.Source = ResourceManager.ImageFromFile (Application.UIPath + "hsplit_bar.png", false);
					Background.SliceType = SliceType.ThreeHorizontal;
					_scrollArea.Background.Source = ResourceManager.ImageFromFile (Application.UIPath + "hsplit_bar_knob.png", false);
	...
	public class ScrollPanel : UIElement
	{
		...
		public void Clear()
		{
			...
			foreach (var t in children)
				t.Owner.Destroy ();
			var components = new List<Component> (Panel.Components);
