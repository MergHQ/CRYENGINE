		...
		public bool IsVertical
		{
			set
			{
				if (value) 
				{
					...
					_knobImg.Source = ResourceManager.ImageFromFile (Application.UIPath + "vsplit_bar_knob.png", false);
				} 
				else 
				{
					Background.Source = ResourceManager.ImageFromFile (Application.UIPath + "hsplit_bar.png", false);
					_knobImg.Source = ResourceManager.ImageFromFile (Application.UIPath + "hsplit_bar_knob.png", false);
				}
			}
