...
namespace CryEngine.UI.Components
{
	...
	public class CollapseCtrl : UIComponent
	{
		...
		ImageSource _arrRt = ResourceManager.ImageFromFile (Application.UIPath + "arrow_rt.png");
		ImageSource _arrDn = ResourceManager.ImageFromFile (Application.UIPath + "arrow_dn.png");
		Object _context;
