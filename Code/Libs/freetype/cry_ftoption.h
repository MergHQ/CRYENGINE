// Crytek note:
// We disable some warnings here so compilation doesn't fail
// Also, we disable most of the FreeType features in this file except for basic TrueType font support
// This file is included automatically by FreeType (instead of the default ftoption.h) because FT_CONFIG_OPTIONS_H is defined
// If you enable more features, make sure to also update the waf_files list to add the required .c files, and update cry_ftmodule.h appropriately
#ifdef _MSC_VER
#define _CRT_SECURE_NO_WARNINGS // fopen, printf etc
#pragma warning(disable:4244 4018) // type conversion, signed mismatch
#endif
// End of note
