...
public class SDLActivity extends Activity {
	...
	public boolean  permission_request_external_storage_granted = false;
	...
	public void verifyStoragePermissions() {
		...
		permission_request_external_storage_granted = ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) ==  PackageManager.PERMISSION_GRANTED;

		if (!permission_request_external_storage_granted) {
		...
		while (permission_request_external_storage_granted == false)
		{
			// Asynch: Wait for user to allow permission. Asynch CB via onRequestPermissionsResult.
		}
	}
			...
			String permissions[], int[] grantResults) 
	{
		switch (requestCode) 
		{
			...
			{
				permission_request_external_storage_granted = true;
			}
			else 
			{
				System.exit(1);
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public SDLSurface(Context context) {
		...
		getHolder().setFixedSize((int)(ratio*horizRes), horizRes);
