	...
	namespace GamePlatform
	{
		namespace Steam
		{
			...
			public:
				...
				virtual bool OpenDialogWithTargetUser(EUserTargetedDialog dialog, IUser::Identifier targetUserId) const;
				virtual bool OpenDialog(const char* szPage) const override;
				virtual bool OpenDialogWithTargetUser(const char* szPage, IUser::Identifier otherUserId) const;
