...
public:
	...
	virtual Cry::Entity::EventFlags GetEventMask() const final { return CDesignerEntityComponent::GetEventMask() | ENTITY_EVENT_START_GAME | ENTITY_EVENT_ATTACH | ENTITY_EVENT_DETACH; }
