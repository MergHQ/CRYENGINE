...
namespace Cry
{
	namespace DefaultComponents
	{
		...
		static void ReflectType(Schematyc::CTypeDesc<CEntityAudioSpotComponent::SAudioTriggerFinishedSignal>& desc)
		{
			...
			desc.AddMember(&CEntityAudioSpotComponent::SAudioTriggerFinishedSignal::m_instanceId, 'inst', "instanceId", "InstanceId", "TriggerId");
			desc.AddMember(&CEntityAudioSpotComponent::SAudioTriggerFinishedSignal::m_triggerId, 'id', "triggerId", "TriggerId", "TriggerId");
			desc.AddMember(&CEntityAudioSpotComponent::SAudioTriggerFinishedSignal::m_bSuccess, 'res', "bSuccess", "Result", "Result");
		}
