...
namespace Cry
{
	namespace DefaultComponents
	{
		...
		void CPlaneConstraintComponent::ReflectType(Schematyc::CTypeDesc<CPlaneConstraintComponent>& desc)
		{
			...
			desc.AddMember(&CPlaneConstraintComponent::m_axis, 'axis', "Axis", "Axis", "Axis around which the physical entity is constrained", Vec3(0.f, 1.f, 1.f));
		...
		void CPlaneConstraintComponent::Run(Schematyc::ESimulationMode simulationMode)
		{
