...
namespace UQS
{
	namespace Core
	{
		...
		protected:
			...
			const std::shared_ptr<const CQueryBlueprint> m_pQueryBlueprint;                // we'll instantiate all query components (generator, evaluators, etc) via this blueprint
		...
		protected:
			// !! m_queryContext: this needs to come after all other member variables, as it relies on their proper initialization!!
