...
namespace UQS
{
	namespace Core
	{
		...
		struct IEditorService
		{
			...
			virtual bool          LoadTextualQueryBlueprint(const char* queryBlueprintName, Editor::IEditorServiceConsumer& callback, Shared::IUqsString& error) const = 0;
			...
			virtual bool          SaveTextualQueryBlueprint(const char* queryBlueprintName, Editor::IEditorServiceConsumer& callback, Shared::IUqsString& error) const = 0;
			...
			virtual bool          CreateNewTextualQueryBlueprint(const char* queryBlueprintName, Editor::IEditorServiceConsumer& callback, Shared::IUqsString& error) const = 0;

			// - removes query blueprint by name
			virtual bool          RemoveQueryBlueprint(const char* queryBlueprintName, Shared::IUqsString& error) const = 0;
