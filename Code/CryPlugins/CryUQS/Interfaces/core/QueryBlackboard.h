...
namespace uqs
{
	namespace core
	{
		...
		{
			explicit                            SQueryBlackboard(const shared::IVariantDict& _globalParams, const IItemList* _pShuttledItems, IDebugRenderWorldPersistent* _pDebugRenderWorldPersistent);
		...
		inline SQueryBlackboard::SQueryBlackboard(const shared::IVariantDict& _globalParams, const IItemList* _pShuttledItems, IDebugRenderWorldPersistent* _pDebugRenderWorldPersistent)
