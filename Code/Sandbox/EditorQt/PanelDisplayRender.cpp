...
SERIALIZATION_ENUM(STEREO_MODE_NO_STEREO, "off", LOCALIZE("No Stereo Output"))
SERIALIZATION_ENUM(STEREO_MODE_DUAL_RENDERING, "dual", LOCALIZE("Dual Rendering"))
SERIALIZATION_ENUM(STEREO_MODE_POST_STEREO, "post", LOCALIZE("Postprocess Stereo"))
SERIALIZATION_ENUM_END()

SERIALIZATION_ENUM_BEGIN(EStereoOutput, "Stereo Output")
SERIALIZATION_ENUM(STEREO_OUTPUT_STANDARD, "off", LOCALIZE("No Stereo Output (Emulation)"))
SERIALIZATION_ENUM(STEREO_OUTPUT_CHECKERBOARD, "Checkerboard", LOCALIZE("Checkerboard"))
SERIALIZATION_ENUM(STEREO_OUTPUT_ABOVE_AND_BELOW, "AboveAndBelow", LOCALIZE("Above and Below (not supported)"))
SERIALIZATION_ENUM(STEREO_OUTPUT_SIDE_BY_SIDE, "SideBySide", LOCALIZE("Side by Side"))
SERIALIZATION_ENUM(STEREO_OUTPUT_LINE_BY_LINE, "Interlaced", LOCALIZE("Interlaced (not supported)"))
SERIALIZATION_ENUM(STEREO_OUTPUT_ANAGLYPH, "Anaglyph", LOCALIZE("Anaglyph"))
SERIALIZATION_ENUM(STEREO_OUTPUT_HMD, "VR", LOCALIZE("VR Headset"))
SERIALIZATION_ENUM_END()
