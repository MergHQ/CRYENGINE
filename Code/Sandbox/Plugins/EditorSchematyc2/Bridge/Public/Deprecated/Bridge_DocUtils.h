...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline uint32 Count(const TScriptFile& file, const SGUID& scopeGUID, EScriptElementType elementType, EVisitFlags visitFlags)
{
	uint32 count = 0;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectGroups(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptGroupVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptGroup> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectGroups(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptGroupConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptGroup> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectSignals(TScriptFile& file, TScriptSignalVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptSignal> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectSignals(const TScriptFile& file, TScriptSignalConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptSignal> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectAbstractInterfaces(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptAbstractInterfaceVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptAbstractInterface> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectAbstractInterfaces(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptAbstractInterfaceConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptAbstractInterface> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectAbstractInterfaceFunctions(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptAbstractInterfaceFunctionVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptAbstractInterfaceFunction> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectAbstractInterfaceFunctions(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptAbstractInterfaceFunctionConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptAbstractInterfaceFunction> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectClasses(TScriptFile& file, TScriptClassVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptClass> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectClasses(const TScriptFile& file, TScriptClassConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptClass> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectStateMachines(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptStateMachineVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptStateMachine> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectStateMachines(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptStateMachineConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptStateMachine> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectStates(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptStateVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptState> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectStates(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptStateConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptState> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectVariables(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptVariableVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptVariable> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectVariables(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptVariableConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptVariable> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectProperties(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptPropertyVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptProperty> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectProperties(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptPropertyConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptProperty> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectContainers(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptContainerVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptContainer> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectContainers(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptContainerConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptContainer> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectTimers(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptTimerVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptTimer> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectTimers(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptTimerConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptTimer> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectAbstractInterfaceImplementations(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptAbstractInterfaceImplementationVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptAbstractInterfaceImplementation> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectAbstractInterfaceImplementations(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptAbstractInterfaceImplementationConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptAbstractInterfaceImplementation> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectComponentInstances(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptComponentInstanceVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptComponentInstance> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectComponentInstances(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptComponentInstanceConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptComponentInstance> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectActionInstances(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptActionInstanceVector& results)
{
	typedef CElementCollector<TScriptFile, IScriptActionInstance> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectActionInstances(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TScriptActionInstanceConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IScriptActionInstance> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectGraphs(TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TDocGraphVector& results)
{
	typedef CElementCollector<TScriptFile, IDocGraph> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline void CollectGraphs(const TScriptFile& file, const SGUID& scopeGUID, bool bRecurseHierarchy, TDocGraphConstVector& results)
{
	typedef CElementCollector<TScriptFile, const IDocGraph> Collector;
...
{
	typedef CElementCollector<TScriptFile, IScriptGraphNode> Collector;
...
{
	typedef CElementCollector<TScriptFile, const IScriptGraphNode> Collector;
...
//////////////////////////////////////////////////////////////////////////
inline const IScriptClass* FindOwnerClass(const TScriptFile& file, const SGUID& scopeGUID)
{
...
//////////////////////////////////////////////////////////////////////////
inline const IScriptStateMachine* FindOwnerStateMachine(const TScriptFile& file, const SGUID& scopeGUID)
{
	const IScriptElement* pElement = file.GetElement(scopeGUID);
	if(pElement)
	{
...
//////////////////////////////////////////////////////////////////////////
inline const IScriptState* FindOwnerState(const TScriptFile& file, const SGUID& scopeGUID)
{
	const IScriptElement* pElement = file.GetElement(scopeGUID);
	if(pElement)
	{
...
//////////////////////////////////////////////////////////////////////////
inline const IDocGraph* FindOwnerGraph(const TScriptFile& file, const SGUID& scopeGUID)
{
	const IScriptElement* pElement = file.GetElement(scopeGUID);
	if(pElement)
	{
...
//////////////////////////////////////////////////////////////////////////
inline void GetFullElementName(const TScriptFile& file, const IScriptElement& element, stack_string& output, EScriptElementType ownerElementType = EScriptElementType::None)
{
...
//////////////////////////////////////////////////////////////////////////
inline void GetFullElementName(const TScriptFile& file, const SGUID& guid, stack_string& output, EScriptElementType ownerElementType = EScriptElementType::None)
{
...
//////////////////////////////////////////////////////////////////////////
inline bool IsElementInScope(const TScriptFile& file, const SGUID& scopeGUID, const SGUID& elementScopeGUID)
{
	if(!elementScopeGUID)
	{
		return true;
...
//////////////////////////////////////////////////////////////////////////
inline bool IsComponentInScope(const TScriptFile& file, const SGUID& scopeGUID, const SGUID& componentGUID)
{
	const IScriptClass* pClass = FindOwnerClass(file, scopeGUID);
	if(pClass)
	{
		IFoundationConstPtr pFoundation = GetSchematyc()->GetEnvRegistry().GetFoundation(pClass->GetFoundationGUID());
		if(pFoundation)
		{
...
{
	//////////////////////////////////////////////////////////////////////////
	inline bool IsActionInScopeOrGroup(const TScriptFile& file, const SGUID& scopeGUID, const SGUID& actionGUID)
	{
...
//////////////////////////////////////////////////////////////////////////
inline bool IsActionInScope(const TScriptFile& file, const SGUID& scopeGUID, const SGUID& actionGUID)
{
	for(const IScriptElement* pScopeElement = file.GetElement(scopeGUID); pScopeElement; pScopeElement = file.GetElement(pScopeElement->GetScopeGUID()))
	{
...
//////////////////////////////////////////////////////////////////////////
inline bool IsElementAvailableInScope(const TScriptFile& file, const SGUID& scopeGUID, const char* szNamespace)
{
	const IScriptClass* pClass = FindOwnerClass(file, scopeGUID);
	if(pClass)
	{
...
//////////////////////////////////////////////////////////////////////////
inline bool IsElementAvailableInScope(const TScriptFile& file, const SGUID& scopeGUID, EEnvElementType ownerType, const SGUID& ownerGUID, const char* szNamespace)
{
	switch(ownerType)
	{
...
inline bool IsSignalAvailableInScope(const TScriptFile& file, const SGUID& scopeGUID, const SGUID& ownerGUID, const char* szNamespace)
{
	if(ownerGUID)
	{
...
//////////////////////////////////////////////////////////////////////////
inline bool IsPartnerStateMachine(const TScriptFile& file, const SGUID& stateMachineGUID)
{
...
//////////////////////////////////////////////////////////////////////////
inline bool IsPartnerState(const TScriptFile& file, const SGUID& stateGUID)
{
...
//////////////////////////////////////////////////////////////////////////
inline bool IsActionAvailableInScope(const TScriptFile& file, const SGUID& scopeGUID, const IActionFactory& actionFactory)
{
...
typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptElement&)> ElementVisitor;
...
public:
	...
	inline CElementVisitWrapper(const TScriptFile& file, const ElementVisitor& visitor, const SGUID& scopeGUID, EVisitFlags visitFlags)
		: m_file(file)
		, m_visitor(visitor)
	...
	{
		const TScriptFile* pIncludeFile = GetSchematyc()->GetScriptRegistry().GetFile(include.GetRefGUID());
		if(pIncludeFile)
		{
...
inline void VisitElements(const TScriptFile& file, const ElementVisitor& visitor, const SGUID& scopeGUID, EVisitFlags visitFlags)
{
...
typedef std::pair<const TScriptFile*, const IScriptElement*> GetElementResult;
...
public:
	...
	inline CGetElementWrapper(const TScriptFile& file, const SGUID& guid)
		: m_file(file)
		, m_guid(guid)
	{
...
inline GetElementResult GetElement(const TScriptFile& file, const SGUID& guid)
{
	return Private::CGetElementWrapper(file, guid).GetResult();
}

typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptInclude&)> IncludeVisitor;
...
public:
	...
	inline CIncludeVisitWrapper(const TScriptFile& file, const IncludeVisitor& visitor)
		: m_file(file)
		, m_visitor(visitor)
	{
...
inline void VisitIncludes(const TScriptFile& file, const IncludeVisitor& visitor)
{
	SCHEMATYC2_SYSTEM_ASSERT(visitor);
	if(visitor)
	{
...
typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptEnumeration&)> EnumerationVisitor;
...
public:
	...
	inline CEnumerationVisitWrapper(const TScriptFile& file, const EnumerationVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
		: m_file(file)
		, m_visitor(visitor)
		, m_scopeGUID(scopeGUID)
...
inline void VisitEnumerations(const TScriptFile& file, const EnumerationVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
{
	SCHEMATYC2_SYSTEM_ASSERT(visitor);
	if(visitor)
	{
...
typedef std::pair<const TScriptFile*, const IScriptEnumeration*> TGetEnumerationResult;
...
public:
	...
	inline CGetEnumerationWrapper(const TScriptFile& file, const SGUID& guid)
		: m_file(file)
		, m_guid(guid)
	{
...
inline TGetEnumerationResult GetEnumeration(const TScriptFile& file, const SGUID& guid)
{
	return Private::CGetEnumerationWrapper(file, guid).GetResult();
}

typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptStructure&)> StructureVisitor;
...
public:
	...
	inline CStructureVisitWrapper(const TScriptFile& file, const StructureVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
		: m_file(file)
		, m_visitor(visitor)
		, m_scopeGUID(scopeGUID)
		, m_bRecurseHierarchy(bRecurseHierarchy)
...
inline void VisitStructures(const TScriptFile& file, const StructureVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
{
	SCHEMATYC2_SYSTEM_ASSERT(visitor);
	if(visitor)
	{
...
typedef std::pair<const TScriptFile*, const IScriptStructure*> TGetStructureResult;
...
public:
	...
	inline CGetStructureWrapper(const TScriptFile& file, const SGUID& guid)
		: m_file(file)
		, m_guid(guid)
	{
...
inline TGetStructureResult GetStructure(const TScriptFile& file, const SGUID& guid)
{
	return Private::CGetStructureWrapper(file, guid).GetResult();
}

typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptSignal&)> SignalVisitor;
...
public:
	...
	inline CSignalVisitWrapper(const TScriptFile& file, const SignalVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
		: m_file(file)
		, m_visitor(visitor)
		, m_scopeGUID(scopeGUID)
		, m_bRecurseHierarchy(bRecurseHierarchy)
...
inline void VisitSignals(const TScriptFile& file, const SignalVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
{
	SCHEMATYC2_SYSTEM_ASSERT(visitor);
	if(visitor)
	{
...
typedef std::pair<const TScriptFile*, const IScriptSignal*> TGetSignalResult;
...
public:
	...
	inline CGetSignalWrapper(const TScriptFile& file, const SGUID& guid)
		: m_file(file)
		, m_guid(guid)
	{
...
inline TGetSignalResult GetSignal(const TScriptFile& file, const SGUID& guid)
{
	return Private::CGetSignalWrapper(file, guid).GetResult();
}

typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptAbstractInterface&)> AbstractInterfaceVisitor;
...
public:
	...
	inline CAbstractInterfaceVisitWrapper(const TScriptFile& file, const AbstractInterfaceVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
		: m_file(file)
		, m_visitor(visitor)
		, m_scopeGUID(scopeGUID)
		, m_bRecurseHierarchy(bRecurseHierarchy)
...
inline void VisitAbstractInterfaces(const TScriptFile& file, const AbstractInterfaceVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
{
	SCHEMATYC2_SYSTEM_ASSERT(visitor);
	if(visitor)
	{
...
typedef std::pair<const TScriptFile*, const IScriptAbstractInterface*> TGetAbstractInterfaceResult;
...
public:
	...
	inline CGetAbstractInterfaceWrapper(const TScriptFile& file, const SGUID& guid)
		: m_file(file)
		, m_guid(guid)
	{
...
inline TGetAbstractInterfaceResult GetAbstractInterface(const TScriptFile& file, const SGUID& guid)
{
	return Private::CGetAbstractInterfaceWrapper(file, guid).GetResult();
}

typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptAbstractInterfaceFunction&)> AbstractInterfaceFunctionVisitor;
...
public:
	...
	inline CAbstractInterfaceFunctionVisitWrapper(const TScriptFile& file, const AbstractInterfaceFunctionVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
		: m_file(file)
		, m_visitor(visitor)
		, m_scopeGUID(scopeGUID)
		, m_bRecurseHierarchy(bRecurseHierarchy)
...
inline void VisitAbstractInterfaceFunctions(const TScriptFile& file, const AbstractInterfaceFunctionVisitor& visitor, const SGUID& scopeGUID, bool bRecurseHierarchy)
{
	SCHEMATYC2_SYSTEM_ASSERT(visitor);
	if(visitor)
	{
...
typedef std::pair<const TScriptFile*, const IScriptAbstractInterfaceFunction*> TGetAbstractInterfaceFunctionResult;
...
public:
	...
	inline CGetAbstractInterfaceFunctionWrapper(const TScriptFile& file, const SGUID& guid)
		: m_file(file)
		, m_guid(guid)
	{
...
inline TGetAbstractInterfaceFunctionResult GetAbstractInterfaceFunction(const TScriptFile& file, const SGUID& guid)
{
	return Private::CGetAbstractInterfaceFunctionWrapper(file, guid).GetResult();
}

typedef TemplateUtils::CDelegate<void (const TScriptFile&, const IScriptClass&)> ClassVisitor;
...
public:
	...
	inline CClassVisitWrapper(const TScriptFile& file, const ClassVisitor& visitor, const SGUID& scopeGUID, EVisitFlags visitFlags)
		: m_file(file)
		, m_visitor(visitor)
		, m_scopeGUID(scopeGUID)
		, m_visitFlags(visitFlags)
...
inline void VisitClasses(const TScriptFile& file, const ClassVisitor& visitor, const SGUID& scopeGUID, EVisitFlags visitFlags)
{
	SCHEMATYC2_SYSTEM_ASSERT(visitor);
	if(visitor)
	{
...
typedef std::pair<const TScriptFile*, const IScriptClass*> GetClassResult;
...
public:
	...
	inline CGetClassWrapper(const TScriptFile& file, const SGUID& guid)
		: m_file(file)
		, m_guid(guid)
	{
...
inline GetClassResult GetClass(const TScriptFile& file, const SGUID& guid)
{
