...
#include <CrySchematyc2/Script/Schematyc_IScriptGraph.h> // #SchematycTODO : Can we remove this include? Right now it's only needed for access to EScriptGraphPortFlags.
