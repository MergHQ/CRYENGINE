...
#include "Serialization/PropertyTreeLegacy/ValidatorBlock.h"
#include "Serialization/QPropertyTreeLegacy/PropertyGroupBox.h"
#include "Serialization/QPropertyTreeLegacy/PropertySplitter.h"
...
static const QFont* translateFont(QPropertyTreeLegacy* tree, Font font)
{
...
void QDrawContext::drawLabel(const char* text, Font font, const Rect& rect, bool selected, bool disabled)
{
	...
	tree_->drawFilteredString(*painter_, text, QPropertyTreeLegacy::RowFilter::NAME, qfont, toQRect(rect), textColor, false, false);
}
...
void QDrawContext::drawButtonWithIcon(const Icon& icon, const Rect& rect, const char* text, int buttonFlags, property_tree::Font font)
{
	...
	static_cast<const QPropertyTreeLegacy*>(tree)->_drawRowValue(*painter_, text, translateFont(tree_, font), textRect, textColor, false, false);
}
...
void QDrawContext::drawValidators(PropertyRow* row, const Rect& totalRect)
{
	...
	QPropertyTreeLegacy* tree = tree_;
