...
bool PropertyRowBool::onKeyDown(PropertyTreeLegacy* tree, const property_tree::KeyEvent* ev)
{
...
bool PropertyRowBool::onMouseDragCheck(PropertyTreeLegacy* tree, bool value)
{
	if (value_ != value) {
...
int PropertyRowBool::widgetSizeMin(const PropertyTreeLegacy* tree) const
{
