...
static int widgetSizeMinHelper(const PropertyTreeLegacy* tree, const PropertyRow* row, RowWidthCache& widthCache)
{
...
property_tree::InplaceWidget* PropertyRowStringListValue::createWidget(PropertyTreeLegacy* tree)
{
	return tree->ui()->createComboBox(this);
}

int PropertyRowStringListValue::widgetSizeMin(const PropertyTreeLegacy* tree) const
{
...
property_tree::InplaceWidget* PropertyRowStringListStaticValue::createWidget(PropertyTreeLegacy* tree)
{
	return tree->ui()->createComboBox(this);
}

int PropertyRowStringListStaticValue::widgetSizeMin(const PropertyTreeLegacy* tree) const
{
	return widgetSizeMinHelper(tree, this, widthCache_);
}
