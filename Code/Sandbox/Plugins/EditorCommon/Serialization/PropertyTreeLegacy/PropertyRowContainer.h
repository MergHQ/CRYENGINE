...
public:
	...
	ContainerMenuHandler(PropertyTreeLegacy* tree, PropertyRowContainer* container);
...
public:
	...
	bool onContextMenu(IMenu& item, PropertyTreeLegacy* tree) override;
	void redraw(IDrawContext& context) override;
	bool onKeyDownContainer(PropertyTreeLegacy* tree, const KeyEvent* key);
	bool onKeyDown(PropertyTreeLegacy* tree, const KeyEvent* key) override;

	void labelChanged() override;
	bool isStatic() const override{ return false; }
	bool isSelectable() const override{ return userWidgetSize() == 0 ? false : true; }
	PropertyRow* addElement(PropertyTreeLegacy* tree, bool append);
	...
	const char* typeNameForFilter(PropertyTreeLegacy* tree) const override;
	...
	int widgetSizeMin(const PropertyTreeLegacy*) const override;

protected:
	virtual void generateMenu(property_tree::IMenu& menu, PropertyTreeLegacy* tree, bool addActions);
