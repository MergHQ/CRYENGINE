...
ContainerMenuHandler::ContainerMenuHandler(PropertyTreeLegacy* tree, PropertyRowContainer* container)
: element()
, container(container)
, tree(tree)
, pointerIndex(-1)
...
{
	ClassMenuItemAdderRowContainer(PropertyRowContainer* row, PropertyTreeLegacy* tree, bool insert = false) 
	: row_(row)
	, tree_(tree)
	, insert_(insert) {}    
...
void PropertyRowContainer::generateMenu(property_tree::IMenu& menu, PropertyTreeLegacy* tree, bool addActions)
{
...
bool PropertyRowContainer::onContextMenu(IMenu& menu, PropertyTreeLegacy* tree)
{
	if(!menu.isEmpty())
		menu.addSeparator();
...
PropertyRow* PropertyRowContainer::addElement(PropertyTreeLegacy* tree, bool append)
{
...
const char* PropertyRowContainer::typeNameForFilter(PropertyTreeLegacy* tree) const 
{
...
bool PropertyRowContainer::onKeyDown(PropertyTreeLegacy* tree, const KeyEvent* ev)
{
...
int PropertyRowContainer::widgetSizeMin(const PropertyTreeLegacy* tree) const
{
