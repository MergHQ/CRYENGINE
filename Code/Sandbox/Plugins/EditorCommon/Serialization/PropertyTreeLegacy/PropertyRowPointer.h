...
public:
	...
	bool                     onContextMenu(IMenu& root, PropertyTreeLegacy* tree) override;
	...
	const char*              typeNameForFilter(PropertyTreeLegacy* tree) const override { return baseType_.name(); }
