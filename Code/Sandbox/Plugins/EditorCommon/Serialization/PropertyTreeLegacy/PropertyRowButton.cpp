...
bool PropertyRowButton::onMouseDown(PropertyTreeLegacy* tree, Point point, bool& changed)
{
...
void PropertyRowButton::onMouseUp(PropertyTreeLegacy* tree, Point point)
{
