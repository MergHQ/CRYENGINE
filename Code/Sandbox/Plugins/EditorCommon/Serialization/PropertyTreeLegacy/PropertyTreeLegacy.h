...
class PROPERTY_TREE_API PropertyTreeLegacy
{
public:
	...
	virtual void attachPropertyTree(PropertyTreeLegacy* propertyTree);
...
protected:
	PropertyTreeLegacy(IUIFacade* ui);
	virtual ~PropertyTreeLegacy();
...
private:
	PropertyTreeLegacy(const PropertyTreeLegacy&) = delete;
	PropertyTreeLegacy& operator=(const PropertyTreeLegacy&) = delete;
protected:
	...
	Objects                            attached_;
	PropertyTreeLegacy*                      attachedPropertyTree_;
