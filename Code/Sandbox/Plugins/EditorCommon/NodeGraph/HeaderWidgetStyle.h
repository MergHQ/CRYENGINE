...
class EDITOR_COMMON_API CHeaderWidgetStyle : public QWidget
{
	Q_OBJECT;
...
public:
	CHeaderWidgetStyle(CNodeGraphViewStyleItem& viewItemStyle);
	...
	const QColor&   GetSelectionColor() const { return m_viewItemStyle.GetSelectionColor(); }
