...
private:
	struct SAssetDescription
	{
		string                           name;
		string                           path;
		const CAssetType*                pAssetType = nullptr;
		const CAssetType::SCreateParams* pCreateParams = nullptr;
		bool                             bChanged = false;
	};

public:
	void                   BeginCreateAsset(const string& path, const string& name, const CAssetType& type, const CAssetType::SCreateParams* pCreateParams);
	void                   EndCreateAsset();
