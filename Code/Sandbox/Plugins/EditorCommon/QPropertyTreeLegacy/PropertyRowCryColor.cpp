...
bool PropertyRowCryColor<ColorClass >::onActivate(const PropertyActivationEvent& e)
{
	...
	PropertyTreeLegacy* prepertyTree = e.tree;
...
template<class ColorClass>
bool PropertyRowCryColor<ColorClass >::onContextMenu(IMenu& menu, PropertyTreeLegacy* tree)
{
...
template<class ColorClass>
bool PropertyRowCryColor<ColorClass >::pickColor(PropertyTreeLegacy* tree)
{
...
CryColorMenuHandler::CryColorMenuHandler(PropertyTreeLegacy* tree, IPropertyRowCryColor* propertyRowColor)
