...
void PropertyRowTagList::generateMenu(property_tree::IMenu& item, PropertyTreeLegacy* tree, bool addActions)
{
...
void PropertyRowTagList::addTag(const char* tag, PropertyTreeLegacy* tree)
{
