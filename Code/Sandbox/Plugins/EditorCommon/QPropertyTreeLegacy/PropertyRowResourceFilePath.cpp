...
ResourceFilePathMenuHandler::ResourceFilePathMenuHandler(PropertyTreeLegacy* tree, PropertyRowResourceFilePath* self)
	: self(self), tree(tree)
{
}
...
Icon PropertyRowResourceFilePath::buttonIcon(const PropertyTreeLegacy* tree, int index) const
{
...
bool PropertyRowResourceFilePath::onContextMenu(property_tree::IMenu& menu, PropertyTreeLegacy* tree)
{
