...
public:
	...
	int             widgetSizeMin(const PropertyTreeLegacy* tree) const override { return 36; }

	int             widgetSizeMax(const PropertyTreeLegacy* tree) const override
	{
...
public:
	...
	int  widgetSizeMin(const PropertyTreeLegacy* tree) const override { return 40; }
