...
struct AABB;
struct SViewportHelperSettings;
...
struct IDisplayViewport
{
	...
	virtual CLevelEditorSharedState::Axis GetPerpendicularAxis(bool* is2D) const = 0;
	...
	virtual Vec3                          MapViewToCP(CPoint point, CLevelEditorSharedState::Axis axis, bool aSnapToTerrain = false, float aTerrainOffset = 0.f) = 0;
	...
	virtual SViewportHelperSettings&      GetHelperSettings() = 0;
};
