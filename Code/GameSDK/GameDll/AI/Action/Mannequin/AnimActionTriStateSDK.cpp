...
////////////////////////////////////////////////////////////////////////////
#include "StdAfx.h"
#include "AnimActionTriStateSDK.h"
...
// ----------------------------------------------------------------------------
CAnimActionTriStateGameSDK::CAnimActionTriStateGameSDK(int priority, FragmentID fragmentID, IAnimatedCharacter& animChar, bool oneShot, float maxMiddleDuration, bool skipIntro, IAnimActionTriStateListenerGameSDK* pListener)
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::OnInitialise()
{
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::Install()
{
...
void CAnimActionTriStateGameSDK::OnRequestBlendOut(EPriorityComparison priorityComp)
{
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::OnAnimationEvent(ICharacterInstance* pCharacter, const AnimEventInstance& event)
{
	CRY_ASSERT(m_eStatus == Installed);
...
// ----------------------------------------------------------------------------
IAction::EStatus CAnimActionTriStateGameSDK::Update(float timePassed)
{
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::Enter()
{
	TBase::Enter();
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::Exit()
{
#ifndef _RELEASE
	if (!m_entered)
		CryFatalError("CAnimActionTriStateGameSDK::Exit: Exit without Enter call");
#endif
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::UnregisterListener()
{
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::InitTargetLocation(const QuatT& targetLocation)
{
#ifndef _RELEASE
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::ClearTargetLocation()
{
#ifndef _RELEASE
	CRY_ASSERT(!m_entered);
#endif
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::InitMovementControlMethods(EMovementControlMethod mcmHorizontal, EMovementControlMethod mcmVertical)
{
#ifndef _RELEASE
	CRY_ASSERT(!m_entered);
#endif
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::OnSequenceFinished(int layer, uint32 scopeID)
{
#ifndef _RELEASE
	CRY_ASSERT(m_entered);
#endif
...
// ----------------------------------------------------------------------------
bool CAnimActionTriStateGameSDK::TrySetTransitionFragment(uint32 fragTagCRC)
{
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::Stop()
{
...
// ----------------------------------------------------------------------------
void CAnimActionTriStateGameSDK::TransitionToNextSubState()
{
	switch (m_subState)
	{
	case eSS_Intro:
