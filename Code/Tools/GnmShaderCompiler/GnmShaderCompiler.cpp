...
#if !defined(SCE_ORBIS_SDK_VERSION) || SCE_ORBIS_SDK_VERSION != 0x06008051u
	#error This GnmShaderCompiler only support SDK 6.008.051
#endif
...
int main(int argc, char* argv[])
{
	if (argc < 7)
	{
		errorStream() <<
		  ...
		  "-HwStage=V2P|V2H|V2G|V2L|C|H2D|H2M|D2P|M2P|G2C2P|L2C2P|P "
