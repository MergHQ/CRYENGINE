/*
	material implementation with base texture acess as material reflection scale
*/
...
: m_pMesh(pMesh), m_pImageData(pImageData), m_ImageWidth(cImageWidth), m_ImageHeight(cImageHeight), m_RedIntensity(1.f), m_GreenIntensity(1.f), m_BlueIntensity(1.f)
{
	assert(pMesh);
	assert(pImageData);
}
