...
{
	OPERAND_TYPE_SPECIAL_TEXCOORD_INPUT = -11,
	OPERAND_TYPE_SPECIAL_LOOPCOUNTER = -10,
	OPERAND_TYPE_SPECIAL_IMMCONSTINT = -9,
	OPERAND_TYPE_SPECIAL_TEXCOORD_OUTPUT = -8,
...
typedef enum OPERAND_MIN_PRECISION
{
	...
	OPERAND_MIN_PRECISION_RESERVED   = 3,
	...
	// special ones
	OPERAND_MIN_PRECISION_ANY_16     = 0xf0,
	OPERAND_MIN_PRECISION_ANY_10     = 0xf1
