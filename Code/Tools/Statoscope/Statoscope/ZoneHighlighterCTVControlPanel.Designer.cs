...
{
	partial class ZoneHighlighterCTVControlPanel
	{
		/// <summary> 
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ZoneHighlighterCTVControlPanel));
			this.tlPanel = new System.Windows.Forms.Panel();
			this.tlToolStrip = new System.Windows.Forms.ToolStrip();
			this.addZoneHighlighterButton = new System.Windows.Forms.ToolStripButton();
			...
			// 
			// addZoneHighlighterButton
			// 
			this.addZoneHighlighterButton.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.addZoneHighlighterButton.Image = ((System.Drawing.Image)(resources.GetObject("addZoneHighlighterButton.Image")));
			this.addZoneHighlighterButton.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.addZoneHighlighterButton.Name = "addZoneHighlighterButton";
			this.addZoneHighlighterButton.Size = new System.Drawing.Size(23, 22);
			this.addZoneHighlighterButton.Text = "Add zone highlighter";
			this.addZoneHighlighterButton.Click += new System.EventHandler(this.addZoneHighlighterButton_Click);
			// 
			// addNodeButton
			// 
			...
			// 
			// ZoneHighlighterCTVControlPanel
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.flowLayoutPanel);
			this.Name = "ZoneHighlighterCTVControlPanel";
		...
		private System.Windows.Forms.ToolStripButton addZoneHighlighterButton;
